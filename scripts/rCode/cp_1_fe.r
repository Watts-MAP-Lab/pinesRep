...
# 
result_case_SI = stan(file="./scripts/stan_models/updatedMultilevelInvLogitFE.stan",
                      data = data_jags, cores=2,chains=2,
                      pars = stanmonitor,
...
#                          pars = stanmonitor,
#                          iter=50000, warmup = 25000, thin = 5,control = list(max_treedepth=12))
saveRDS(result_case_SI, file = "./data/brmsModsOut/cp_1_FE.RDS")


## Now run all of these cp_1 varainats
#system("Rscript scripts/rCode/cp_1_fe_gaus.r & Rscript scripts/rCode/cp_1_fe.r & Rscript scripts/rCode/cp_1_re_gaus.r")