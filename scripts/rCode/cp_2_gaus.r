...
result_case_DEGAU = stan(file="./scripts/stan_models/doubleChangePoint_gaus.stan",
                      data = data_jags, cores=2,chains=2,
                      pars = stanmonitor,
                      iter=10000, warmup = 3000, thin = 5,control = list(max_treedepth=12))
saveRDS(result_case_DEGAU, file = "./data/brmsModsOut/cp_2_RE_Gaus.RDS")

## Now run all of these in bash
# system("Rscript scripts/rCode/cp_2_gauss.r & Rscript scripts/rCode/cp_2_fe.r & Rscript scripts/rCode/cp_2_fe_gaus.r")